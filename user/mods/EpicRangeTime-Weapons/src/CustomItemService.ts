...
export class CustomItemService
{
    ...
    public postDBLoad(): void 
    {
        ...
        this.createExampleCloneItem(itemConfig, itemId);
            ...
            //this.modifyQuests(this.Instance.database, jsonUtil);
            numItemsAdded++;
        }
   ...
   */
    ...
    private modifyQuests(tables: IDatabaseTables , jsonUtil: any): void 
    {
        ...
        if (punisherpt3) 
        {
            const punisher3aks = punisherpt3.conditions.AvailableForFinish[0].counter.conditions[0].weapon;
    
            punisherpt3.conditions.AvailableForFinish[0].counter.conditions[0].weapon = [
                ...jsonUtil.clone(punisher3aks),
                ...newaks74us
            ];
        }
        ...
        if (wetjobpt1) 
        {
            const wetjobpt1supp = wetjobpt1.conditions.AvailableForFinish[0].counter.conditions[0].weaponModsInclusive;
    
            wetjobpt1.conditions.AvailableForFinish[0].counter.conditions[0].weaponModsInclusive = [
                ...jsonUtil.clone(wetjobpt1supp),
                ...newsuppressors
            ];
        }
        ...
        if (wetjobpt1) 
        {
            const wetjobpt1weap = wetjobpt1.conditions.AvailableForFinish[0].counter.conditions[0].weapon;
    
            wetjobpt1.conditions.AvailableForFinish[0].counter.conditions[0].weapon = [
                ...jsonUtil.clone(wetjobpt1weap),
                ...newm4s
            ];
        }
        ...
        if (tarkshooterpt1) 
        {
            const tarkshooterpt1weap = tarkshooterpt1.conditions.AvailableForFinish[0].counter.conditions[0].weapon;
    
            tarkshooterpt1.conditions.AvailableForFinish[0].counter.conditions[0].weapon = [
                ...jsonUtil.clone(tarkshooterpt1weap),
                ...newbolties
            ];
        }
        ...
        if (punisher2) 
        {
            const punisher2supp = punisher2.conditions.AvailableForFinish[0].counter.conditions[0].weaponModsInclusive;
    
            punisher2.conditions.AvailableForFinish[0].counter.conditions[0].weaponModsInclusive = [
                ...jsonUtil.clone(punisher2supp),
                ...newsuppressors
            ];
        }
    }
